...
public void draw() {
  ...
  fill(50, 0, 100+((vacancy2000[1]-vacancy2010[1])/20));
  noStroke();
  shape(alabama, -250, -150);
  alaska.disableStyle();
  fill(50, 0, 100+((vacancy2000[2]-vacancy2010[2])/20));
  noStroke();
  shape(alaska, -250, -150);
  arizona.disableStyle();
  fill(50, 0, 100+((vacancy2000[3]-vacancy2010[3])/20));
  noStroke();
  shape(arizona, -250, -150);
  arkansas.disableStyle();
  fill(50, 0, 100+((vacancy2000[4]-vacancy2010[4])/20));
  noStroke();
  shape(arkansas, -250, -150);
  california.disableStyle();
  fill(50, 0, 100+((vacancy2000[5]-vacancy2010[5])/20));
  noStroke();
  shape(california, -250, -150);
  colorado.disableStyle();
  fill(50, 0, 100+((vacancy2000[6]-vacancy2010[6])/20));
  noStroke();
  shape(colorado, -250, -150);
  connecticcut.disableStyle();
  fill(50, 0, 100+((vacancy2000[7]-vacancy2010[7])/20));
  noStroke();
  shape(connecticcut, -250, -150);
  delaware.disableStyle();
  fill(50, 0, 100+((vacancy2000[8]-vacancy2010[8])/20));
  noStroke();
  shape(delaware, -250, -150);
  districtofcolumbia.disableStyle();
  fill(50, 0, 100+((vacancy2000[9]-vacancy2010[9])/20));
  noStroke();
  shape(districtofcolumbia, -250, -150);
  florida.disableStyle();
  fill(50, 0, 100+((vacancy2000[10]-vacancy2010[10])/20));
  noStroke();
  shape(florida, -250, -150);
  georgia.disableStyle();
  fill(50, 0, 100+((vacancy2000[11]-vacancy2010[11])/20));
  noStroke();
  shape(georgia, -250, -150);
  hawaii.disableStyle();
  fill(50, 0, 100+((vacancy2000[12]-vacancy2010[12])/20));
  noStroke();
  shape(hawaii, -250, -150);
  idaho.disableStyle();
  fill(50, 0, 100+((vacancy2000[13]-vacancy2010[13])/20));
  noStroke();
  shape(idaho, -250, -150);
  illinois.disableStyle();
  fill(50, 0, 100+((vacancy2000[14]-vacancy2010[14])/20));
  noStroke();
  shape(illinois, -250, -150);
  indiana.disableStyle();
  fill(50, 0, 100+((vacancy2000[15]-vacancy2010[15])/20));
  noStroke();
  shape(indiana, -250, -150);
  iowa.disableStyle();
  fill(50, 0, 100+((vacancy2000[16]-vacancy2010[16])/20));
  noStroke();
  shape(iowa, -250, -150);
  kansas.disableStyle();
  fill(50, 0, 100+((vacancy2000[17]-vacancy2010[17])/20));
  noStroke();
  shape(kansas, -250, -150);
  kentucky.disableStyle();
  fill(50, 0, 100+((vacancy2000[18]-vacancy2010[18])/20));
  noStroke();
  shape(kentucky, -250, -150);
  louisiana.disableStyle();
  fill(50, 0, 100+((vacancy2000[19]-vacancy2010[19])/20));
  noStroke();
  shape(louisiana, -250, -150);
  maine.disableStyle();
  fill(50, 0, 100+((vacancy2000[20]-vacancy2010[20])/20));
  noStroke();
  shape(maine, -250, -150);
  maryland.disableStyle();
  fill(50, 0, 100+((vacancy2000[21]-vacancy2010[21])/20));
  noStroke();
  shape(maryland, -250, -150);
  massachusetts.disableStyle();
  fill(50, 0, 100+((vacancy2000[22]-vacancy2010[22])/20));
  noStroke();
  shape(massachusetts, -250, -150);
  michigan.disableStyle();
  fill(50, 0, 100+((vacancy2000[23]-vacancy2010[23])/20));
  noStroke();
  shape(michigan, -250, -150);
  minnesota.disableStyle();
  fill(50, 0, 100+((vacancy2000[24]-vacancy2010[24])/20));
  noStroke();
  shape(minnesota, -250, -150);
  mississippi.disableStyle();
  fill(50, 0, 100+((vacancy2000[25]-vacancy2010[25])/20));
  noStroke();
  shape(mississippi, -250, -150);
  missouri.disableStyle();
  fill(50, 0, 100+((vacancy2000[26]-vacancy2010[26])/20));
  noStroke();
  shape(missouri, -250, -150);
  montana.disableStyle();
  fill(50, 0, 100+((vacancy2000[27]-vacancy2010[27])/20));
  noStroke();
  shape(montana, -250, -150);
  nebraska.disableStyle();
  fill(50, 0, 100+((vacancy2000[28]-vacancy2010[28])/20));
  noStroke();
  shape(nebraska, -250, -150);
  nevada.disableStyle();
  fill(50, 0, 100+((vacancy2000[29]-vacancy2010[29])/20));
  noStroke();
  shape(nevada, -250, -150);
  newhampshire.disableStyle();
  fill(50, 0, 100+((vacancy2000[30]-vacancy2010[30])/20));
  noStroke();
  shape(newhampshire, -250, -150);
  newjersey.disableStyle();
  fill(50, 0, 100+((vacancy2000[31]-vacancy2010[31])/20));
  noStroke();
  shape(newjersey, -250, -150);
  newmexico.disableStyle();
  fill(50, 0, 100+((vacancy2000[32]-vacancy2010[32])/20));
  noStroke();
  shape(newmexico, -250, -150);
  newyork.disableStyle();
  fill(50, 0, 100+((vacancy2000[33]-vacancy2010[33])/20));
  noStroke();
  shape(newyork, -250, -150);
  northcarolina.disableStyle();
  fill(50, 0, 100+((vacancy2000[34]-vacancy2010[34])/20));
  noStroke();
  shape(northcarolina, -250, -150);
  northdakota.disableStyle();
  fill(50, 0, 100+((vacancy2000[35]-vacancy2010[35])/20));
  noStroke();
  shape(northdakota, -250, -150);
  ohio.disableStyle();
  fill(50, 0, 100+((vacancy2000[36]-vacancy2010[36])/20));
  noStroke();
  shape(ohio, -250, -150);
  oklahoma.disableStyle();
  fill(50, 0, 100+((vacancy2000[37]-vacancy2010[37])/20));
  noStroke();
  shape(oklahoma, -250, -150);
  oregon.disableStyle();
  fill(50, 0, 100+((vacancy2000[38]-vacancy2010[38])/20));
  noStroke();
  shape(oregon, -250, -150);
  pennsylvania.disableStyle();
  fill(50, 0, 100+((vacancy2000[39]-vacancy2010[39])/20));
  noStroke();
  shape(pennsylvania, -250, -150);
  rhodeisland.disableStyle();
  fill(50, 0, 100+((vacancy2000[40]-vacancy2010[40])/20));
  noStroke();
  shape(rhodeisland, -250, -150);
  southcarolina.disableStyle();
  fill(50, 0, 100+((vacancy2000[41]-vacancy2010[41])/20));
  noStroke();
  shape(southcarolina, -250, -150);
  southdakota.disableStyle();
  fill(50, 0, 100+((vacancy2000[42]-vacancy2010[42])/20));
  noStroke();
  shape(southdakota, -250, -150);
  tennessee.disableStyle();
  fill(50, 0, 100+((vacancy2000[43]-vacancy2010[43])/20));
  noStroke();
  shape(tennessee, -250, -150);
  texas.disableStyle();
  fill(50, 0, 100+((vacancy2000[44]-vacancy2010[44])/20));
  noStroke();
  shape(texas, -250, -150);
  utah.disableStyle();
  fill(50, 0, 100+((vacancy2000[45]-vacancy2010[45])/20));
  noStroke();
  shape(utah, -250, -150);
  vermont.disableStyle();
  fill(50, 0, 100+((vacancy2000[46]-vacancy2010[46])/20));
  noStroke();
  shape(vermont, -250, -150);
  virginia.disableStyle();
  fill(50, 0, 100+((vacancy2000[47]-vacancy2010[47])/20));
  noStroke();
  shape(virginia, -250, -150);
  washington.disableStyle();
  fill(50, 0, 100+((vacancy2000[48]-vacancy2010[48])/20));
  noStroke();
  shape(washington, -250, -150);
  westvirginia.disableStyle();
  fill(50, 0, 100+((vacancy2000[49]-vacancy2010[49])/20));
  noStroke();
  shape(westvirginia, -250, -150);
  wisconsin.disableStyle();
  fill(50, 0, 100+((vacancy2000[50]-vacancy2010[50])/20));
  noStroke();
  shape(wisconsin, -250, -150);
  wyoming.disableStyle();
  fill(50, 0, 100+((vacancy2000[51]-vacancy2010[51])/20));
  noStroke();
  shape(wyoming, -250, -150);
save("heatmap.png");
}
  public void settings() {  size(1500, 650); }
