...
public void setup() {
  ...
  usa = loadShape("usa-wikipedia.svg");
   alabama = usa.getChild("MI");
   alaska = usa.getChild("MI");
   arizona = usa.getChild("MI");
   arkansas = usa.getChild("MI");
   california = usa.getChild("MI");
   colorado = usa.getChild("MI");
   connecticcut = usa.getChild("MI");
   delaware = usa.getChild("MI");
   districtofcolumbia = usa.getChild("MI");
   florida = usa.getChild("MI");
   georgia = usa.getChild("MI");
   hawaii = usa.getChild("MI");
   idaho = usa.getChild("MI");
   illinois = usa.getChild("MI");
   indiana = usa.getChild("MI");
   iowa = usa.getChild("MI");
   kansas = usa.getChild("MI");
   kentucky = usa.getChild("MI");
   louisiana = usa.getChild("MI");
   maine = usa.getChild("MI");
   maryland = usa.getChild("MI");
   massachusetts = usa.getChild("MI");
  michigan = usa.getChild("MI");
   minnesota = usa.getChild("MI");
   mississippi = usa.getChild("MI");
   missouri = usa.getChild("MI");
   montana = usa.getChild("MI");
   nebraska = usa.getChild("MI");
   nevada = usa.getChild("MI");
   newhampshire = usa.getChild("MI");
   newjersey = usa.getChild("MI");
   newmexico = usa.getChild("MI");
   newyork = usa.getChild("MI");
   northcarolina = usa.getChild("MI");
   northdakota = usa.getChild("MI");
