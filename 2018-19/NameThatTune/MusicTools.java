public class MusicTools{
  ...
  **/
  ...
  //  printArray(array1);
    ...
    *@author, By David Claude Michalovich Bershadsky
    **/
    public static double[] weightedAddArray(double array[], double array1[]){
      System.out.println("weightedAddArray");
      //printArray(array);
      //printArray(array1);
      double[] ret = new double[array.length];
      double[] ret1 = new double[array1.length];
      if (array.length>=array1.length) {
        for (int i=0;i<array1.length ;i++ ) {
          ret[i]=array[i]+array1[i];
        }
    ...
    *@author, By David Claude Michalovich Bershadsky
    **/
    public static double[] coppyArray(double array[], int n, int n1){
      System.out.println("coppyArray");
    //  printArray(array);
      double[] ret = new double[n1-n];
      if (array.length>=n1-n) {
        for (int i=n;i<n1 ;i++ ) {
          ret[i-n]+=array[i];
        }
        return(ret);
    ...
    **/
    ...
    public static double[] concatArray(double array[], double array1[]){
      ...
      for (int i=array.length;i<array.length+array1.length ;i++ ) {
        ret[i]=array1[i-array.length];
      }
      return(ret);
    }
    ...
    //  printArray(array1);
      ...
      for (int i=n;i<array1.length+n ;i++ ) {
        //  System.out.println("i2= "+i);
        ret[i]+=array1[i-n];
      }
      for (int i=n+array1.length;i<array1.length+array.length ;i++ ) {
        //  System.out.println("i3= "+i);
        ret[i]+=array[i-n-array1.length];
      }
      return(ret);
    }
    ...
    public static void main(String args[]){
      ...
      printArray(arrayave(a));
      System.out.println();
      System.out.println("done");
      System.out.println();

      printArray(findArrayMax(a));
      System.out.println();
      System.out.println("done");
      System.out.println();

      printArray(findArrayMin(a));
      System.out.println();
      System.out.println("done");
      System.out.println();
